...
const Skills = () => {
  ...
  const content = {
    fr: {
      ...
      cert1Title: 'Développeur Full Stack Python || MERN',
      cert1Org: 'Coding Dojo Africa',
      cert1Period: 'Septembre 2023 - Juin 2024',
      cert2Title: 'Certification JavaScript Basics',
      cert2Org: 'BigData Processing',
      cert2Period: 'IBM Cognitive Class'
    },
    en: {
      title: 'Skills',
      ...
      certificationsTitle: 'Certifications',
      cert1Title: 'Full Stack Python || MERN Developer',
      cert1Org: 'Coding Dojo Africa',
      cert1Period: 'September 2023 - June 2024',
      cert2Title: 'JavaScript Basics Certification',
      cert2Org: 'BigData Processing',
      cert2Period: 'IBM Cognitive Class'
    }
  };
